...
const en = {
  ...
  clientBookNote:
    "Your client list. It's yours — export it anytime, even if you switch shops.",
  exportCsv: "Export CSV",
  csvExported: "Client list downloaded.",
  visits: "visits",
  oneVisit: "1 visit",
  lastVisit: "Last visit",
  noClientsYet: "No clients yet. They’ll show up here after their first visit.",

  // Shop
  shopTitle: "The shop",
  shopBarbersTitle: "Barbers at {shop}",
  viewBarber: "View Barber",
  findShopTitle: "Find your barber",
  findShopSubtitle: "Search by city, neighborhood, or ZIP.",
  searchPlaceholder: "City, neighborhood, or ZIP",
  noShopsFound: "No shops found there yet. Try another city or ZIP.",
  barbersCount: "{n} barbers",
  availableNowCount: "{n} available now",
  viewShop: "View Shop",

  // Owner dashboard
  ownerDashboard: "Shop Owner",
  ownerSubtitle: "Your shop at a glance — every chair, one screen.",
  managingShop: "Managing",
  inLineNow: "In line now",
  bookingsToday: "Bookings today",
  cutsToday: "Cuts done today",
  chairs: "Chairs",
  ownerRosterNote:
    "Each barber runs his own book and clients. You see the totals — not their client lists.",
  ...
  viewPublicShopPage: "View public shop page",
  forOwners: "For shop owners",
  forOwnersPitch:
    "See every chair's line and bookings in one place — without touching your barbers' client books.",
  openOwnerView: "Open the shop owner view",
  shopFollowNote:
    "Follow your barber, not just the shop. Every barber keeps their own line and bookings — even if they move.",
...
const es: Record<TranslationKey, string> = {
  ...
  joinBeforePullUp: "Apúntate en la fila antes de salir de tu casa",
  ...
  inLineFor:
    "Ya estás en la fila de {name}. Tranquilo — te avisamos cuando vayas de próximo.",
  ...
  queueClosedTitle: "La fila está cerrada por ahora",
  queueClosedBody:
  ...
  emptyQueue: "Nadie en fila todavía. Comparte tu link y llena esa silla.",
  ...
  clientBookNote:
    "Tu lista de clientes. Es tuya — expórtala cuando quieras, aunque cambies de barbería.",
  exportCsv: "Exportar CSV",
  csvExported: "Lista de clientes descargada.",
  visits: "visitas",
  oneVisit: "1 visita",
  lastVisit: "Última visita",
  noClientsYet: "Todavía no hay clientes. Aparecerán aquí después de su primera visita.",

  shopTitle: "La barbería",
  shopBarbersTitle: "Barberos en {shop}",
  viewBarber: "Ver barbero",
  findShopTitle: "Encuentra a tu barbero",
  findShopSubtitle: "Busca por ciudad, vecindario o ZIP.",
  searchPlaceholder: "Ciudad, vecindario o ZIP",
  noShopsFound: "Todavía no hay barberías ahí. Prueba otra ciudad u otro ZIP.",
  barbersCount: "{n} barberos",
  availableNowCount: "{n} disponibles ahora",
  viewShop: "Ver barbería",

  ownerDashboard: "Dueño de barbería",
  ownerSubtitle: "Tu barbería de un vistazo — todas las sillas, una pantalla.",
  managingShop: "Administrando",
  inLineNow: "En fila ahora",
  bookingsToday: "Reservas hoy",
  cutsToday: "Cortes hechos hoy",
  chairs: "Sillas",
  ownerRosterNote:
    "Cada barbero maneja su propia agenda y sus clientes. Tú ves los totales — no sus listas de clientes.",
  shopProfile: "Perfil de la barbería",
  shopNameLabel: "Nombre de la barbería",
  shopDescriptionLabel: "Descripción",
  shopPhoneLabel: "Teléfono de la barbería",
  saveShop: "Guardar barbería",
  shopSaved: "Barbería guardada.",
  viewPublicShopPage: "Ver página pública de la barbería",
  forOwners: "Para dueños de barbería",
  forOwnersPitch:
    "Mira la fila y las reservas de cada silla en un solo lugar — sin tocar los clientes de tus barberos.",
  openOwnerView: "Abrir la vista del dueño",
  shopFollowNote:
    "Sigue a tu barbero, no solo a la barbería. Cada barbero mantiene su propia fila y reservas — aunque cambie de local.",
